...
theorem support_mul [Mul G] [DecidableEq G] (a b : k[G]) : 
...
theorem support_single_mul_subset [DecidableEq G] [Mul G] (f : k[G]) (r : k) (a : G) :
...
theorem support_mul_single_subset [DecidableEq G] [Mul G] (f : k[G]) (r : k) (a : G) :
...
theorem support_single_mul_eq_image [DecidableEq G] [Mul G] (f : k[G]) {r : k}
...
theorem support_mul_single_eq_image [DecidableEq G] [Mul G] (f : k[G]) {r : k}
...
theorem support_mul_single [Mul G] [IsRightCancelMul G] (f : k[G]) (r : k)
    (hr : ∀ y, y * r = 0 ↔ y = 0) (x : G) :
...
theorem support_single_mul [Mul G] [IsLeftCancelMul G] (f : k[G]) (r : k)
    (hr : ∀ y, r * y = 0 ↔ y = 0) (x : G) :
